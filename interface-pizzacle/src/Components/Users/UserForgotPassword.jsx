              ...
              <>
                  <section className="flex justify-center items-center lg:p-48 bg-black p-5 h-screen">
                      <form onSubmit={handleSubmit} className=" w-96">
                          ...
                          <Link to='/user/login' class="material-symbols-outlined text-green-500">
                              arrow_back
                          </Link>
                          ...
                          <button type="submit" className="bg-green-700 p-3 text-white rounded w-full mb-3 font-bold" disabled={buttonText === "Sending OTP..."}>{buttonText}</button>
                      </form>
                  </section>
              </>
          )}
